...
constexpr DefaultBand kDefaultBands[] = {
    {0, 3'000'000'000LL, 500'000'000LL, 180.0, "#4BB4FF", "#7FCBFF", "#DDF4FF"},
    {1, 5'795'000'000LL, 410'000'000LL, 160.0, "#35D07F", "#7CF3A9", "#E3FFF0"},
    {2, 8'250'000'000LL, 500'000'000LL, 190.0, "#E5B84B", "#FFD671", "#FFF2C5"},
    {3, 9'550'000'000LL, 500'000'000LL, 140.0, "#E46BD4", "#FF9AF0", "#FFE0FA"},
    {4, 14'250'000'000LL, 500'000'000LL, 170.0, "#8A7CFF", "#B6AEFF", "#ECE9FF"},
};
